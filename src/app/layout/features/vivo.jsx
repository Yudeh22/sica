  ...
  useEffect(() => {
    async function initCamera() {
      try {
        ...
        console.error("Error al inicializar la cámara trasera:", error);
        ...
        try {
          ...
          console.error("Error al inicializar la cámara frontal:", frontError);
          throw new Error("No se pudo inicializar ninguna cámara");
        }
      }
    }
    ...
    async function init() {
      ...
      try {
        ...
        const webcamInstance = await initCamera();
