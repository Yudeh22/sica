...
const EnvivoComponentCell = () => {
  ...
  return (
    <Sidebar.Pushable style={{ minHeight: "100vh" }}>
      ...
      <Sidebar.Pusher dimmed={sidebarVisible}>
      <Menu fixed="top" style={{ backgroundColor: "#14539A", borderBottom: "5px solid #14539A", width: '100%', zIndex: 1000 }}>
        <Menu.Item onClick={handleSidebarToggle} style={{ fontSize: '18px', color: '#f9fafb', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
            <Icon name="sidebar" style={{ color: "#f9fafb", marginRight: '8px' }} />
            <span style={{ whiteSpace: 'nowrap' }}>Sistema Clasificador de Atunes</span>
        </Menu.Item>
        <Menu.Item position="right" style={{ padding: '0' }}>
            <img 
            src="/atun/logex/3.png" 
            alt="Mi Icono" 
            style={{ 
                height: '54px', 
                maxHeight: '54px',
        ...
        <Container style={{ marginTop: '110px', display: 'flex', justifyContent: 'left', alignItems: 'center' }}>
          <Header as={"h2"} style={{ textAlign: 'left', marginBottom: '20px' }}>Reconocimiento en Vivo para Móviles</Header>
        </Container>
        ...
        <Container style={{ marginTop: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '20px' }}>
          <Button color="green" onClick={refreshPage} style={{ fontSize: '15px', padding: '12px 20px' }}>Abrir Cámara</Button>
          <Button color="red" onClick={closeCamera} style={{ fontSize: '15px', padding: '12px 20px' }}>Cerrar Cámara</Button>
          <Button color={frozen ? "orange" : "blue"} onClick={toggleFreeze} style={{ fontSize: '15px', padding: '12px 20px' }}>
            {frozen ? "Descongelar" : "Congelar"}
          </Button>
        </Container>
